            ...
            <div className="flex gap-4">
              {['light', 'dark', 'system'].map((t) => (
                <button
                  ...
                  className={`flex-1 h-12 rounded-xl border-2 text-sm font-medium capitalize transition-all ${settings.theme === t
        ...
        <div className="space-y-6">
          ...
          <Card className="p-6 border-blue-100 dark:border-slate-800">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <p className="text-center text-xs text-slate-400 dark:text-slate-500 pt-4">
                  Ease Me Up v1.0.0 • Made with ❤️ by <a href="https://prajwalshelar.online/" target="_blank" className="hover:text-blue-600 transition-colors">Prajwal Shelar</a> • MIT License
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-slate-100 dark:border-slate-800 text-center">
              ...
              <Button className="w-full bg-amber-400 hover:bg-amber-500 text-amber-950 font-black rounded-xl gap-2 h-11 shadow-sm shadow-amber-200" onClick={() => window.open('https://prajwalshelar.online/', '_blank')}>
                ☕ Support Developer
              </Button>
